...
step_sequence = [
    ...
    [1, 0, 0, 0],  # Activate IN1 + IN2
    [1, 0, 0, 0],  # Activate IN2
    [1, 0, 0, 0],  # Activate IN2 + IN3
    [1, 0, 0, 0],  # Activate IN3
    [1, 0, 0, 0],  # Activate IN3 + IN4
    [1, 0, 0, 0],  # Activate IN4
    [1, 0, 0, 0]   # Activate IN4 + IN1
]
