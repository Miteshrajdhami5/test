...
ast_gps_location = "https://www.google.com/maps?q=27.671167,85.439778"
        ...
        while retry_count < max_retries:
            ...
            if face_landmarks:
                ...
                if abs(eye_angle) > 15:
                    ...
                    print(f"Face rotated (angle: {eye_angle:.1f}Â°) - please face straight forward")
...
def compare_faces(captured_image_path):
    ...
    try:
        ...
        for image_path, ref_encoding in reference_encodings:
            ...
            if face_distance < 0.4 and confidence > 50:
