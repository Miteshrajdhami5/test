...
def send_sms():
    ...
    website_url = 'http://192.168.83.42:5000'
...
def send_image_to_owner(captured_image_path):
    ...
    image_url = f"http://192.168.83.42:5000/captured_image"
    ...
    Check authorization on: http://192.168.83.42:5000
...
def index():
    ...
    start_url = 'http://192.168.83.42:5000/start_vehicle'

    stop_url = 'http://192.168.83.42:5000/stop_vehicle'

    location_url = 'http://192.168.83.42:5000/send_location'

    map_redirect_url = 'http://192.168.83.42:5000/redirect_to_map'
